    ...
    return Obx(() {
      if (companyController.isLoading.value) {
        ...
        return ListView.builder(
          cacheExtent: 1000, // تحسين الأداء عند التمرير
          ...
          itemBuilder: (context, index) {
            ...
            return CompanyRowWidget(
              ...
              status: company.country == "اليمن" ? Icons.check_circle : Icons.cancel,
              statusColor: company.country == "اليمن" ? Colors.green : Colors.red,
          ...
          children: [
            ClipRRect(
              ...
              child: imagePath.isNotEmpty
                  ? CachedNetworkImage(
                imageUrl: "http://192.168.150.162:8000$imagePath",
                width: 50,
                height: 50,
                fit: BoxFit.cover,
